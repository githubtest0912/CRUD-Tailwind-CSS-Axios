...
const Nav = ({ search, setSearch }) => {
  return (
    <nav className="relative flex flex-wrap items-center justify-between w-full py-3 text-gray-200 bg-gray-900 shadow-lg navbar navbar-expand-lg navbar-light">
        ...
        >
          ...
          <ul className="flex flex-col pl-0 mr-auto navbar-nav list-style-none">
            <li className="p-2 nav-item">
              <NavLink
                className="p-0 text-white nav-link opacity-60 hover:opacity-80 focus:opacity-80"
                to="/"
              >
                Home
              </NavLink>
